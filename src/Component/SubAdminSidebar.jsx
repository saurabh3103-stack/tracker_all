  ...
  return (
    <>
      <section className="sidebar">
        ...
        <div>
          <Link to="/sub-admin/dashboard" className="sidebar-logo" style={{fontSize:"1.9rem",fontWeight:"700",lineHeight:"1",alignItems:"center"}}>
        ...
        <div className="sidebar-menu-area bg-primary">
          <ul className="sidebar-menu" id="sidebar-menu">
            ...
            >
              ...
              >
                <li>
                  <Link to="sub-admin/verifier">
                    <i className="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                    Verifier
                  </Link>
                </li>
                <li>
                  <Link to="sub-admin/add-verifier">
                    <i className="ri-circle-fill circle-icon text-warning-main w-auto"></i>
                    Add Verifier
                  </Link>
                </li>
            ...
            >
              ...
              >
                <li>
                  <Link to="sub-admin/today-report">
                    <i className="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                    Today
                  </Link>
                </li>
                <li>
                  <Link to="sub-admin/all-report">
                    <i className="ri-circle-fill circle-icon text-warning-main w-auto"></i>
                    All Report
                  </Link>
                </li>
